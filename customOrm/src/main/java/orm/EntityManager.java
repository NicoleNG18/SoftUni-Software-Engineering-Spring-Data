...
public class EntityManager<E> implements DBContext<E> {
    ...
    private static final String ID_COLUM_MISSING_MESSAGE = "orm.annotations.Entity missing an orm.annotations.Id column";
    private static final String CLASS_MUST_BE_ENTITY_MESSAGE = "Class must be orm.annotations.Entity";
